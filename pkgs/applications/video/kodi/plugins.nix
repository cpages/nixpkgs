...
let self = rec {
  ...
  pvr-hdhomerun = mkKodiABIPlugin rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "pvr.hdhomerun";
      rev = "${version}-${rel}";
      sha256 = "08l4v0alrbnilsdk96rxgis8cmkj78jq4sp2pjkz14qgvhh95bbf";
    };
  ...
  pvr-iptvsimple = mkKodiABIPlugin rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "pvr.iptvsimple";
      rev = "${version}-${rel}";
      sha256 = "00am3m435nvsag1az29f9qlrzrcrdd5fqlhjjjplc9i9rfsknd1c";
    };
  ...
  inputstream-adaptive = mkKodiABIPlugin rec {
    ...
    src = fetchFromGitHub {
      ...
      rev = "${version}-${rel}";
      sha256 = "1iks6s0cb5j17lpxdd6b3girdhz5rs38c7q5f9qqg45yi0wwaw0a";
    };
